export const serviceCard1Data = [
  {
    ...
    para1:
      " Minimize legal risks by ensuring compliance with industry standards through risk mitigation strategies. ",
    para2:
  ...
  },
  {
    ...
    benefits:
      "Our legal document review services are designed to provide you with the support you need to navigate the pre-litigation process with greater ease. We understand the importance of these documents and are committed to helping you achieve the best possible outcome",
    para1:
      "  Minimize business disruption with strategic litigation support.  ",
    para2:
  ...
  },
  {
    ...
    benefits:
      "Our legal document review services are designed to provide you with the support you need to navigate the pre-litigation process with greater ease. We understand the importance of these documents and are committed to helping you achieve the best possible outcome",
    para1:
      "  Simplifies the business registration process with expert guidance. ",
    para2:
  ...
  },
  {
    ...
    benefits:
      "Our legal document review services are designed to provide you with the support you need to navigate the pre-litigation process with greater ease. We understand the importance of these documents and are committed to helping you achieve the best possible outcome",
    para1:
      "  Identify and mitigate legal risks before they become costly issues.  ",
  ...
  {
    id: 7,
    title: "Family Law & Divorce Cases",
    description:
      "Get expert legal assistance for family disputes, divorce cases, and child custody agreements.",
  },
  {
    id: 8,
    title: "Corporate Law Compliance",
    description:
      "Ensure your business complies with corporate laws and regulations to avoid penalties and legal risks.",
  },
  {
    id: 9,
    title: "Taxation & Financial Legal Advisory",
    description:
      "Receive expert legal counsel on tax matters, financial planning, and dispute resolution.",
  },
  {
    id: 10,
    title: "Criminal Law Consultation",
    description:
      "Get professional legal defense and representation for criminal charges and investigations.",
  },
  {
    id: 11,
    title: "Real Estate Legal Services",
    description:
      "Ensure smooth real estate transactions with expert legal guidance on buying, selling, and leasing properties.",
  },
  {
    id: 12,
    title: "Startup & Entrepreneurship Legal Support",
    description:
      "Set up your startup legally with proper documentation, compliance, and investment agreements.",
  },
  {
    id: 13,
    title: "Mergers & Acquisitions Legal Assistance",
    description:
      "Navigate complex M&A transactions with legal due diligence and risk management solutions.",
  },
  {
    id: 14,
    title: "Cyber Law & Data Protection",
    description:
      "Protect your digital assets, data privacy, and intellectual property from cyber threats and legal risks.",
  },
  {
    id: 15,
    title: "Arbitration & Mediation Services",
    description:
      "Resolve disputes outside court with professional arbitration and mediation services.",
  },
  {
    id: 16,
    title: "International Trade & Business Law",
    description:
      "Get legal support for cross-border trade, foreign investments, and international business agreements.",
  },
  {
    id: 17,
    title: "Banking & Finance Law",
    description:
      "Ensure compliance with banking regulations, financial transactions, and investment policies.",
  },
  {
    id: 18,
    title: "Personal Injury Claims",
    description:
      "Seek compensation for personal injury cases, workplace accidents, and medical negligence.",
  },
  {
    id: 19,
    title: "Insurance Law & Claim Settlements",
    description:
      "Get legal support for insurance claims, policy disputes, and settlements.",
  },
  {
    id: 20,
    title: "Intellectual Property Litigation",
    description:
      "Protect and enforce your IP rights through expert legal representation in litigation.",
  },
  {
    id: 21,
    title: "Environmental Law & Compliance",
    description:
      "Ensure your business follows environmental laws and sustainability regulations.",
  },
  {
    id: 22,
    title: "E-Commerce Legal Support",
    description:
      "Comply with e-commerce laws, online business regulations, and consumer protection policies.",
  },
  {
    id: 23,
    title: "Healthcare & Medical Law",
    description:
      "Navigate legal issues in healthcare, medical malpractice, and patient rights.",
  },
  {
    id: 24,
    title: "Defamation & Media Law",
    description:
      "Protect your reputation and handle legal matters related to defamation and media laws.",
  },
  {
    id: 25,
    title: "Education Law & Institutional Compliance",
    description:
      "Ensure educational institutions meet legal standards and regulatory requirements.",
  },
  {
    id: 26,
    title: "Maritime & Shipping Law",
    description:
      "Handle legal matters related to maritime trade, shipping regulations, and vessel contracts.",
  },
  {
    id: 27,
    title: "Artificial Intelligence & Tech Law",
    description:
      "Understand the legal implications of AI, automation, and emerging technologies in business.",
  },
];
